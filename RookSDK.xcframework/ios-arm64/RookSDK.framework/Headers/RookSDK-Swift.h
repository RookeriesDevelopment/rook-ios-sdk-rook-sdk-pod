...
#ifndef ROOKSDK_SWIFT_H
#define ROOKSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RookSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (void)getDataSourceAuthorizerWithUserId:(NSString * _Nullable)userId dataSource:(NSString * _Nonnull)dataSource redirectUrl:(NSString * _Nullable)redirectUrl completion:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, NSError * _Nullable))completion;
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)setConfigurationWithClientUUID:(NSString * _Nonnull)clientUUID secret:(NSString * _Nonnull)secret bundleId:(NSString * _Nullable)bundleId enableBackgroundSync:(BOOL)enableBackgroundSync enableEventsBackgroundSync:(BOOL)enableEventsBackgroundSync;
- (void)setEnvironmentForSandbox;
- (void)setEnvironmentForProduction;
- (void)initRookWithCompletion:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completion SWIFT_METHOD_FAMILY(none);
