...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)setConfigurationWithClientId:(NSString * _Nonnull)clientId sha:(NSString * _Nonnull)sha enableBackgroundSync:(BOOL)enableBackgroundSync enableEventsBackgroundSync:(BOOL)enableEventsBackgroundSync;
