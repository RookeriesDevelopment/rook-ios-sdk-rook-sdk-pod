...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git =>  "https://github.com/RookeriesDevelopment/rook-ios-sdk-rook-sdk-pod.git", :tag => "1.3.4" }

  spec.ios.vendored_frameworks = 'RookSDK.xcframework'

  spec.dependency 'RookAppleHealth', '1.5.2'
  spec.dependency 'RookConnectTransmission', '1.2.8'
  spec.dependency 'RookUsersSDK', '1.0.6'
