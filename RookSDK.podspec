...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git =>  "https://github.com/RookeriesDevelopment/rook-ios-sdk-rook-sdk-pod.git", :tag => "1.4.7" }

  spec.ios.vendored_frameworks = 'RookSDK.xcframework'

  spec.dependency 'RookAppleHealth', '1.6.2'
  spec.dependency 'RookConnectTransmission', '1.3.3'
  spec.dependency 'RookUsersSDK', '1.1.1'
