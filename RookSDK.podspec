...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git =>  "https://github.com/RookeriesDevelopment/rook-ios-sdk-rook-sdk-pod.git", :tag => "1.0.8" }

  spec.ios.vendored_frameworks = 'RookSDK.xcframework'

  spec.dependency 'RookAppleHealth', '1.0.15'
  spec.dependency 'RookConnectTransmission', '1.0.12'
